...
class Hybrid(NDaysNCampaignsAgent):

    def __init__(self, name: str = "Hybrid", beta=0.4, long_factor=0.6):
        super().__init__()
        self.name = name
        self.beta = beta
    ...
    def get_campaign_bids(self, campaigns_for_auction: Set[Campaign]) -> Dict[Campaign, float]:
            ...
            for campaign in campaigns_for_auction:
                ...
                raw_bid  = base_bid \
                        ...
                        * (1.0 if is_short else self.long_factor)
...
if __name__ == "__main__":
    bots = [Hybrid()] + [Tier1NDaysNCampaignsAgent(name=f"Tier1 {i}") for i in range(9)]
